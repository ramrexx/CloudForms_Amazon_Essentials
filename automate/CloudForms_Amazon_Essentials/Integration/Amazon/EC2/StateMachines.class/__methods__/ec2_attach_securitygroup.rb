...
begin
  ...
  existing_sg.each {|sg| new_securitygroup_array << sg[:group_id] }
  new_securitygroup_array << security_group.ems_ref
  ...
  @vm.custom_set(:ec2_securitygroup_policy, 'PASS')
  #@vm.refresh
